...
node{
    ...
    stage('编译,安装service_user工程'){
            ...
            try{
                ...
                sh "docker run  --name=service_user -d -p 8210:8210 service_user -e spring.profiles.active=prod"
            }catch(Throwable e){
    ...
    stage('编译,安装service_common工程'){
            ...
            try{
                ...
                sh "docker run  --name=service_common -d -p 8202:8202 service_common -e spring.profiles.active=prod"
            }catch(Throwable e){
    ...
    stage('编译,安装service_company工程'){
            ...
            try{
                ...
                sh "docker run  --name=service_company -d -p 8201:8201 service_company -e spring.profiles.active=prod"
            }catch(Throwable e){
    ...
    stage('编译,安装service_oss工程'){
            ...
            try{
                ...
                sh "docker run  --name=service_oss -d -p 8205:8205 service_oss -e spring.profiles.active=prod"
            }catch(Throwable e){
    ...
    stage('编译,安装 service_sms 工程'){
            ...
            try{
                ...
                sh "docker run  --name=service_sms -d -p 8204:8204 service_sms -e spring.profiles.active=prod"
            }catch(Throwable e){
    ...
    stage('编译,安装 gateway 工程'){
            ...
            try{
                ...
                sh "docker run  --name=gateway -d -p 8666:8666 gateway -e spring.profiles.active=prod"
            }catch(Throwable e){
